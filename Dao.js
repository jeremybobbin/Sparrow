...
module.exports = class Dao {
    ...
    init() {
        let sql = [
            'CREATE TABLE IF NOT EXISTS urls ( id INT NOT NULL AUTO_INCREMENT, userId INT NOT NULL, `url` VARCHAR(512) NOT NULL, `widget` BOOLEAN DEFAULT TRUE, `show` BOOLEAN DEFAULT TRUE, `delay` TINYINT NOT NULL DEFAULT 3, `effect` VARCHAR(255) DEFAULT \'fade\' , `location` VARCHAR(255) NOT NULL DEFAULT \'bottom-left\', `show_counters` BOOLEAN NOT NULL DEFAULT FALSE, `initial_wait` TINYINT DEFAULT 3, PRIMARY KEY(id) ); ',
